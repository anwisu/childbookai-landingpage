      ...
      {showSections && (
        <div className="relative w-full h-6 flex items-center">
          ...
          <div className="absolute left-0 text-center" style={{ transform: 'translateX(0)' }}>
            <span className="text-xs sm:text-sm font-medium text-foreground">Request</span>
          </div>

          {/* Story label */}
          <div className="absolute left-1/2 -translate-x-1/2 text-center">
            <span className="text-xs sm:text-sm font-medium text-foreground">Story</span>
          </div>

          {/* Image label */}
          <div className="absolute right-0 text-center" style={{ transform: 'translateX(0)' }}>
            <span className="text-xs sm:text-sm font-medium text-foreground">Image</span>
          </div>
        </div>
      )}
