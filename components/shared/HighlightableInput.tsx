  ...
  return (
    <div className="space-y-1">
      ...
      <div
        ...
        className="w-full min-h-[72px] bg-blue-100 border border-blue-800 rounded-md p-3 text-md focus:outline-none focus-visible:ring-1 focus-visible:ring-blue-800"
